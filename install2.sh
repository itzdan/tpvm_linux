...
show_menu(){
    ...
    echo '──█── █▀▀█ █▄▄▀ █▀▀ █▄▄█ ──█── █──█ █──█ █▄▄▀ ▀▀█ █──█ ▀█▀ ──█──'
    echo '──▀── ▀──▀ ▀─▀▀ ▀▀▀ ▀──▀ ──▀── █▀▀▀ ─▀▀▀ ▀─▀▀ ▀▀▀ ─▀▀▀ ▀▀▀ ──▀──'
    echo '(v) 0.4 dev edition (w) https://github.com/itzdan/tpvm_linux | (c) actual[at]google[.]com'
    
# Function to perform the system update and package installation
install_packages() {
    echo "Starting the system update and package installation process..."
